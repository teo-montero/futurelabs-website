...
export function ContactSponsor() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 ${isVisible ? 'animate-slide-up' : 'opacity-0'}`}>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Get in touch to learn more about our partnership opportunities, sponsorships, and requirements.
          </p>
        </div>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-[#4a6cff]/5 to-[#7c4dff]/5 border border-[#4a6cff]/20">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 mt-4">Partnerships Questions</p>
                  <p className="font-medium text-gray-900">partnerships@futurelabs.co.uk</p>
                </div>
              </CardContent>
            </Card>
